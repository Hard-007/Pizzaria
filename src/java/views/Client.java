...
public class Client extends JPanel implements ActionListener{
    ...
    public Client(String accessLevel){
        ...
        cardImgIcon		= new ImageIcon("src/resources/assets/restaurant.png");
        cardImgResize 	= cardImgIcon.getImage().getScaledInstance(230, 180, Image.SCALE_SMOOTH);
		...
		clientJPanel.add(menuHeaderJPanel, BorderLayout.NORTH);
		clientJPanel.add(scrollPane, BorderLayout.CENTER);
		clientJPanel.add(menuFooterJPanel, BorderLayout.SOUTH);
	...
	public void actionPerformed(ActionEvent e){
		if (e.getSource() == actualizar) {
			...
			revalidate();
			repaint();
			clientJPanel.add(menuBodyJPanel, BorderLayout.CENTER);
		}
			...
			revalidate();
			repaint();
			clientJPanel.add(addPizzaJPanel, BorderLayout.CENTER);
		}
		else{
			for(int i = 0; i<100; i++){
